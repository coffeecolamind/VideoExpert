...
class BaseDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        i = rng.randint(0, len(self.list_data_dict))
        
        try:
            sources, det_target = self.get_sources(i)
        ...
        if isinstance(i, int):
            ...
            if det_target:
                data_dict["timestamp"] = det_target["timestamp"]
                data_dict["span_label_nn"] = det_target["span_label_nn"]
                data_dict["timestamp_window"] = det_target["timestamp_window"]
